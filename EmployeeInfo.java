...
public class EmployeeInfo extends JFrame implements ActionListener{
    ...
    EmployeeInfo(){
        ...
        t1 = new JTable();
        t1.setBounds(15, 100, 950, 430);
        add(t1);
        
        JLabel l9 = new JLabel("EMPLOYEE INFO");
        l9.setFont(new Font("Cambria", Font.BOLD, 30));
	l9.setBounds(360, 05, 300, 40);
	add(l9);
